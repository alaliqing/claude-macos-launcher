...
# Remove the legacy workflow name if it exists
...
echo "==============================================================="
echo ""
echo "1. 'Open Claude with Selection'"
echo "   -> Right-click selected items in Finder -> context menu"
echo "   -> Opens Claude with your selection staged"
echo ""
...
echo "==============================================================="
echo ""
echo "- The first time you use 'Open Claude with Selection', macOS may ask for Accessibility permission"
echo "- If selection auto-typing fails, open System Settings -> Privacy & Security -> Accessibility"
echo "- Enable Finder, then run 'Open Claude with Selection' again"
echo ""
echo "==============================================================="
echo "Usage:"
echo "==============================================================="
echo ""
echo "- Right-click selected items in Finder -> 'Open Claude with Selection'"
