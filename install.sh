...
lines = [
    ...
    '  done',
    '  ',
    '  # Build the keystroke string with all filenames',
    '  KEYSTROKE=""',
    '  for item in "${ITEMS[@]}"; do',
    '    FILENAME=$(basename "$item")',
    '    # Do NOT use printf %q here - it breaks Unicode/Chinese characters',
    '    KEYSTROKE="$KEYSTROKE@$FILENAME "',
    '  done',
    '  ',
    '  # Auto-type all @filenames',
